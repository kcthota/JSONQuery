...
public class QueryTest {
	...
	public void testSubstringof() {
		...
		result = q.is(substringof("age", "Kris")); // age not a string, returns
													// false
		assertThat(result).isFalse();
	...
	public void testStartsWith() {
		...
		result = q.is(startsWith("age", "Kris")); // age not a string, returns
													// false
		assertThat(result).isFalse();
	...
	public void testEndsWith() {
		...
		result = q.is(endsWith("age", "Kris")); // age not a string, returns
												// false
		assertThat(result).isFalse();
