 ...
 */
public class AppendToValueExpression extends StringValueExpression {
	...
	public AppendToValueExpression(String property, String appendText, ValueExpression innerExpression) {
